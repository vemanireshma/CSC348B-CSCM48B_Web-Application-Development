                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link {{ Request::is('admin/category') || Request::is('admin/edit-category/*') ? 'collapse active' : '' }}"
                            ...
                            <div class="collapse {{ Request::is('admin/add-category') || Request::is('admin/category') || Request::is('admin/edit-category/*') ? 'show' : '' }}"
                            ...
                            <a class="nav-link {{ Request::is('admin/posts') || Request::is('admin/edit-post/*') ? 'collapse active' : '' }}"
                            ...
                            <div class="collapse {{ Request::is('admin/add-post') || Request::is('admin/posts') || Request::is('admin/post/*') ? 'show' : '' }}"
